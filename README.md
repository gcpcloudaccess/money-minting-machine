...
| Portfolio Decision Layer | `app/portfolio/` — portfolio_manager, position_sizing (respects ₹10,00,000 cash-only cap, no margin), scenario_analysis, execution_advisor |
